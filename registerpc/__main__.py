...
from registerpc import __version__
from registerpc.app import MainWindow
from registerpc.config import get_config
from registerpc.logger import logger
from registerpc.utils import newIcon
...
def main():
    ...
    default_config_file = os.path.join(os.path.expanduser('~'), '.registerpcrc')
    parser.add_argument(
        '--config',
        dest='config',
