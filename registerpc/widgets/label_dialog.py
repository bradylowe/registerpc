...
class LabelDialog(QtWidgets.QDialog):
    ...
    def __init__(self, text="Enter object label", parent=None, labels=None,
        ...
        self.edit.setValidator(registerpc.utils.labelValidator())
        ...
        bb.button(bb.Ok).setIcon(registerpc.utils.newIcon('done'))
        bb.button(bb.Cancel).setIcon(registerpc.utils.newIcon('undo'))
